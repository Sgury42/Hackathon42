...
export default ({ type, data, options, height }) => {
  ...
  const config = {
    bar: {
      scales: {
        ...
        yAxes: [{
          gridLines: { borderDash: [4, 4], zeroLineWidth: 0 },
        }],
      },
    },
    line: {
  ...
  Chart.defaults = _.merge(Chart.defaults, config)
